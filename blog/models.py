...
class Article(models.Model):
    ...
    para_1 = models.TextField(max_length=750, null=True)
    para_2 = models.TextField(max_length=750, null=True)
    para_3 = models.TextField(max_length=750, null=True)
    conclusion = models.TextField(max_length=500, null=True)
